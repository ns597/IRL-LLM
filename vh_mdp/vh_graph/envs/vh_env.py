...
from virtualhome.simulation.evolving_graph.utils import load_graph_dict, load_name_equivalence, graph_dict_helper
from virtualhome.simulation.evolving_graph.execution import ScriptExecutor, ExecutionInfo
from virtualhome.simulation.evolving_graph.scripts import read_script_from_string, Action
...
class VhGraphEnv(gym.Env):
    ...
    def get_image(self, num_static_cameras, agent_id, num_camera_per_agent, CAMERA_NUM, info, comm):
        camera_ids = [num_static_cameras + agent_id * num_camera_per_agent + CAMERA_NUM]
        ...
        if 'mode' in info:
            ...
            current_mode = 'normal'
        s, images = comm.camera_image(camera_ids, mode=current_mode, image_width=image_width, image_height=image_height)
        print("images", images)
        return images[0]       
